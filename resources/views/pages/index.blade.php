...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/71457547" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
</head>

<body class="bg-gray-800">
    <div class="w-full h-16 bg-gray-900 bg-opacity-30">
        <a href="/" class="text-gray-200 h-full font-bold text-xl flex items-center mx-4 uppercase">
            imgfy
        </a>
    </div>
        ...
        <div class="flex justify-center items-center">
            <div class="w-96">
                ...
                <div class="text-center mb-4">
                    <div class="focus:outline-none relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                        <input type="checkbox" name="secret" id="secret" class="focus:outline-none toggle-checkbox absolute block w-5 h-5 rounded-full border-gray-900 border-opacity-50 border-4 appearance-none cursor-pointer bg-gray-50"/>
                        <label for="secret" class="toggle-label block overflow-hidden h-5 rounded-full bg-gray-700 cursor-pointer"></label>
                    </div>
                ...
                <div id="wrapper" class="hidden">
                    <div class="flex">
                        <input readonly type="text" name="link" id="link" class="mr-2 focus:outline-none transform transition duration-200 focus:ring-4 focus:ring-purple-500 text-gray-200 w-full px-5 py-2 rounded-md bg-dark-gray" placeholder="https://example.com/image.jpg">
                        <a id="open" href="#" target="_blank" class="flex-auto focus:outline-none transform transition duration-200 hover:bg-opacity-100 hover:shadow-xl focus:ring-4 focus:ring-purple-500 focus:ring-opacity-60 rounded-md bg-dark-gray bg-opacity-80 px-5 py-2 text-white font-bold">
                            <svg class="w-5 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                        </a>
                    </div>
                    
                    <button id="copy" class="mt-4 w-full focus:outline-none transform transition duration-200 hover:bg-opacity-100 hover:shadow-xl focus:ring-4 focus:ring-purple-500 focus:ring-opacity-60 rounded-md bg-purple-500 bg-opacity-80 px-5 py-2 text-white font-bold">copy</button>
                </div>
            </div>
          </div>
    </div>

    <footer class="mt-5 md:mt-8 text-center text-gray-500 text-xs px-4">
        <div>Imgfy it is forever free & unlimited service for storage images.</div>
        <div>Uploaded images for all time: <strong>{{ $totalImagesCount }}</strong></div>
        <div class="mt-2">&copy; 2020 <a href="//imgfy.cf/" class="text-gray-600 hover:underline">Imgfy</a></div>
    </footer>
